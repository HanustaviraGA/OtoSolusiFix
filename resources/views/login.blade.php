...
<html lang="en">
	...
	<head>
		<base href="../../">
		<meta charset="utf-8" />
		<title>Otomotif Solusi | Login</title>
			...
			<div class="kt-grid__item   kt-grid__item--fluid kt-grid  kt-grid kt-grid--hor kt-login-v2" id="kt_login_v2">
				...
				<div class="kt-grid__item  kt-grid--hor">
					...
					<div class="kt-login-v2__head">
                        ...
                        <h5 style="text-align: center !important;">Otomotif Solusi</h5>
						{{-- <div class="kt-login-v2__signup">
							<span><a href="#" class="kt-link kt-font-brand">Halaman Depan</a></span>
						</div> --}}
					</div>
					...
					<div class="kt-login-v2__body">
						...
						<div class="kt-login-v2__wrapper">
							<div class="kt-login-v2__container">
								...
								<!--begin::Form-->
								<form class="kt-login-v2__form kt-form" action="{{ route('login') }}" method="POST" autocomplete="off">
									@csrf
								...
								<div class="kt-login-v2__options">
                                    ...
                                    <h5 class="kt-login-v2__desc">Silakan login menggunakan username dan password Anda</h5>
								</div>
				...
				<div class="kt-grid__item">
					<div class="kt-login-v2__footer">
						<div class="kt-login-v2__link">
							<a href="#" class="kt-link kt-font-brand">Kontak</a>
						</div>
						<div class="kt-login-v2__info">
							<a href="https://modifwebsite.id" class="kt-link">&copy; <?= date('Y') ?> Otomotif Solusi</a>
						</div>
					</div>
				</div>
